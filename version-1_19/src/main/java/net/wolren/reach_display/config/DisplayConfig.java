...
public class DisplayConfig extends MidnightConfig {
    ...
    @Entry(name = "Distance Band 1 Threshold", isSlider = true, min = 0.0f, max = 10.0f, precision = 10)
    ...
    @Entry(name = "Distance Band 2 Threshold", isSlider = true, min = 0.0f, max = 10.0f, precision = 10)
    ...
    @Entry(name = "Distance Background Opacity", isSlider = true, min = 0.0f, max = 1.0f)
    ...
    @Entry(name = "Hit Band 1 Threshold", isSlider = true, min = 0.0f, max = 10.0f, precision = 10)
    ...
    @Entry(name = "Hit Band 2 Threshold", isSlider = true, min = 0.0f, max = 10.0f, precision = 10)
    ...
    @Entry(name = "Hit Background Opacity", isSlider = true, min = 0.0f, max = 1.0f)
    ...
    @Entry(name = "Average Hit Band 1 Threshold", isSlider = true, min = 0.0f, max = 10.0f, precision = 10)
    ...
    @Entry(name = "Average Hit Band 2 Threshold", isSlider = true, min = 0.0f, max = 10.0f, precision = 10)
    ...
    @Entry(name = "Average Hit Background Opacity", isSlider = true, min = 0.0f, max = 1.0f)
