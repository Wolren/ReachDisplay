...
public class DisplayConfig extends MidnightConfig {
    ...
    @Entry(name = "Distance Gradient Max", min = 0.1f, max = 10.0f)
    ...
    @Entry(name = "Hit Gradient Max", min = 0.1f, max = 10.0f)
    ...
    @Entry(name = "Average Hit Gradient Max", min = 0.1f, max = 10.0f)
